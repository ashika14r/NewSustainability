...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("Create table consumption(Consumption_ID integer primary key, email text, water double, electricity double, gas double, achieved boolean, whichMonth text)");
    ...
    public boolean insertConsumption(String email, double water, double electricity, double gas, boolean achieved, String whichMonth){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("email", email);
        ...
        contentValues.put("whichMonth", whichMonth);
