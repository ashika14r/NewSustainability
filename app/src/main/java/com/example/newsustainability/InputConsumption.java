...
public class InputConsumption extends AppCompatActivity {
    ...
    EditText WaterInput, ElectricityInput, GasInput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isInserted = db.insertConsumption(email,water,electricity,gas,Achieve);
        ...
        BtnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                while(result.moveToNext()) {
                    buffer.append("Month: " + result.getInt(0)+"\n");
